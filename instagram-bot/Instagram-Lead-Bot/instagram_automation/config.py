...
يقرأ المتغيرات من ملف .env أو من متغيرات البيئة مباشرة
"""
...
# ── تحميل .env إن وُجد (محلياً أو على السيرفر) ──
try:
    from dotenv import load_dotenv as _load
    _env_file = _BASE.parent / ".env"
    if _env_file.exists():
        _load(dotenv_path=str(_env_file), override=False)
except ImportError:
    pass  # python-dotenv غير مثبت — يستخدم متغيرات البيئة مباشرة
